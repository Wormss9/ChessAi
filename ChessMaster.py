...
whiteModel:keras.Model = keras.models.load_model('models/white12.h5')
blackModel:keras.Model = keras.models.load_model('models/testModel.h5')
app = FastAPI()
...
async def predict(board: Board):
    ...
    #return board.shape
    print(str(whiteModel.predict(board)[0]))
